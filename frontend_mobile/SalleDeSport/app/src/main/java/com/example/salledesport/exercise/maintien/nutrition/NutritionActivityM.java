...
public class NutritionActivityM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nutrition_m);  // Lien vers le fichier XML de mise en page
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(NutritionActivityM.this, NutritionDetailsM.class);
