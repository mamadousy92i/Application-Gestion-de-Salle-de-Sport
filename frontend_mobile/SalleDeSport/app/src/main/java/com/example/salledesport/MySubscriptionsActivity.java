...
public class MySubscriptionsActivity extends BaseActivity implements SubscriptionAdapter.OnSubscriptionActionListener {
    ...
    private FloatingActionButton addSubscription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Configurer le bouton historique
        ...
        addSubscription= findViewById(R.id.addSubscriptionFab);
        ...
        addSubscription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MySubscriptionsActivity.this,Abonnement.class));
            }
        });
    }
