...
public class NutritionActivityPM extends AppCompatActivity {
    ...
    private int[] slideshowImages = {
            R.drawable.slide6,  // Images liées à la nutrition
            R.drawable.slide7,
            R.drawable.slide8,
            R.drawable.slide9
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nutrition_pm);  // Lien vers le fichier XML de mise en page
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(NutritionActivityPM.this, NutritionDetailsPM.class);
